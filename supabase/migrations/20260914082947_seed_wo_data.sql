...
SELECT 'WO-202609-0001', '2026-09-10', 'High', 'Corrective', 'Area Produksi A',
...
WHERE NOT EXISTS (SELECT 1 FROM work_orders WHERE wo_number = 'WO-202609-0001');
...
SELECT 'WO-202609-0002', '2026-09-12', 'Critical', 'Corrective', 'Utilitas',
...
WHERE NOT EXISTS (SELECT 1 FROM work_orders WHERE wo_number = 'WO-202609-0002');
...
SELECT 'WO-202609-0003', '2026-09-08', 'Medium', 'Preventive', 'HVAC Room',
...
WHERE NOT EXISTS (SELECT 1 FROM work_orders WHERE wo_number = 'WO-202609-0003');
...
SELECT 'WO-202609-0004', '2026-09-05', 'Low', 'Preventive', 'Workshop',
...
WHERE NOT EXISTS (SELECT 1 FROM work_orders WHERE wo_number = 'WO-202609-0004');
...
SELECT 'WO-202609-0005', '2026-09-14', 'Medium', 'Corrective', 'Area Packaging',
  ...
  'OPEN'
WHERE NOT EXISTS (SELECT 1 FROM work_orders WHERE wo_number = 'WO-202609-0005');

-- Set sequence so next auto-generated WO is WO-202609-0006
...
FROM work_orders wo WHERE wo.wo_number = 'WO-202609-0003'
...
SELECT id, 'CREATED', 'Work Order dibuat', NULL, 'OPEN' FROM work_orders WHERE wo_number = 'WO-202609-0001'
ON CONFLICT DO NOTHING;

INSERT INTO activity_logs (work_order_id, action, description, old_status, new_status)
SELECT id, 'STATUS_CHANGE', 'Status berubah dari OPEN ke ASSIGNED', 'OPEN', 'ASSIGNED' FROM work_orders WHERE wo_number = 'WO-202609-0001'
ON CONFLICT DO NOTHING;

INSERT INTO activity_logs (work_order_id, action, description, old_status, new_status)
SELECT id, 'STATUS_CHANGE', 'Status berubah dari ASSIGNED ke IN PROGRESS', 'ASSIGNED', 'IN PROGRESS' FROM work_orders WHERE wo_number = 'WO-202609-0001'
ON CONFLICT DO NOTHING;
...
FROM work_orders wo WHERE wo.wo_number = 'WO-202609-0001'
